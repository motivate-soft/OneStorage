...
<script>
    const faqData = [{
            ...
            faqs: [{
                ...
                answer: '電話：(852) 2111 2636EMAIL：cs@onestorage.com.hkWhatsApp：(852) 54907251星期一至五: 早上10:00至下午1:00及下午2:00至晚上7:00星期六日及公眾假期: 早上10:00至下午1:00及下午2:00至5:00星期日及公眾假期 需於 1 天前預約'
            }]
        },
        {
            category: '尺寸選擇',
    ...
    function init() {
        ...
        faqData[0].faqs.forEach(faq => {
            contentWrapper.append('<div class="accordion relative appearance-none items-center">' + faq.question + '<div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700">' +
