...
<div class=" w-96 mx-auto mt-4 mb-12 px-5">
    <div class=" flex">
        ...
        <p class=" text-center w-full pt-4 pb-2 font-bold regular-color fontsize-18">{{__('frontend_rentwarehouse.applyImmediately')}} </p>
    </div>

    <form class="px-8 pt-5">

        <p class=" font-bold mb-4 fontsize-21 regular-color">{{__('frontend_rentwarehouse.WCH')}} </p>

        <p class=" font-bold mb-4 fontsize-20 regular-color"><span class=" fontsize-25">12</span>{{__('frontend_rentwarehouse.squareFeet')}} </p>
        ...
        <div class="flex mb-4 w-full pt-8 border-t">
            <div class="flex w-1/2 input-group">
                ...
                <input class="w-full form-control fontsize-12" type="text" placeholder="{{__('frontend_common.firstName')}}">
            </div>
            <div class="w-1/2 flex input-group">
                <input class="w-full form-control fontsize-12 " style="margin-left: 4px;padding-left:12px" type="text" placeholder="{{__('frontend_common.lastName')}}">
            </div>
        </div>
        ...
        <div class="input-group mb-4">
            ...
            <input class="form-control" type="text" placeholder="{{__('frontend_common.mobileNumber')}}">
        </div>
        ...
        <div class="w-full inline-block relative pb-4 border-b">
            <input class="w-full form-control pb-8 border-b" style="padding: 16px 8px 16px 16px;" type="text" placeholder="{{__('frontend_rentwarehouse.yourMessage')}}">
        ...
        <div class=" flex py-4 mt-2 border-t">
            <div class="w-2/5">
                <p class=" text-center font-bold fontsize-18" style="color: #988F9A">{{__('frontend_rentwarehouse.shareIt')}}</p>
            </div>
