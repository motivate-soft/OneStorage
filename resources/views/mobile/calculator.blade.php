...
<div class="relative block bg-white main-wrapper">
    ...
    <div class="flex overflow-x-auto pt-10 px-10 pb-5">
        <div class="flex-shrink-0 relative max-w-md rounded overflow-hidden shadow-lg room-card-wrapper-m store-select mx-3">
            <img class="room-card-image mx-auto" src="{{ asset('calculator/rooms-03@2x.png') }}" alt="Room">
            <div class="px-6 py-4">
        ...
        <div class="flex-shrink-0 relative max-w-md rounded overflow-hidden shadow-lg room-card-wrapper-m store-select mx-3 active">
            <img class="room-card-image mx-auto" src="{{ asset('calculator/rooms-04@2x.png') }}" alt="Room">
            <div class="px-6 py-4">
        ...
        <div class="flex-shrink-0 relative max-w-md rounded overflow-hidden shadow-lg room-card-wrapper-m store-select mx-3">
            <img class="room-card-image mx-auto" src="{{ asset('calculator/rooms-05@2x.png') }}" alt="Room">
            <div class="px-6 py-4">
        ...
        <div class="flex-shrink-0 relative max-w-md rounded overflow-hidden shadow-lg room-card-wrapper-m store-select mx-3">
            <img class="room-card-image mx-auto" src="{{ asset('calculator/rooms-06@2x.png') }}" alt="Room">
            <div class="px-6 py-4">
    ...
    <div class="grid grid-cols-1 row-gap-1 pb-10">
        <div class="flex p-6">
            <img class="flex-shrink-0 calculator-others-item-image" src="{{ asset('calculator/Image 82@2x.png') }}"/>
        ...
        <div class="flex p-6">
            <img class="flex-shrink-0 calculator-others-item-image" src="{{ asset('calculator/Intersection 39@2x.png') }}"/>
            <p class="text-base font-weight-bolder color-primary px-5 leading-6">政府派1萬蚊 點先最快收到錢？</p>
        </div>
        <div class="calculator-others-item-divider"></div>
        <div class="flex p-6">
            <img class="flex-shrink-0 calculator-others-item-image" src="{{ asset('calculator/Image 84@2x.png') }}"/>
