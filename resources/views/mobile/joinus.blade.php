...
<body class=" bg-white" ondragstart="return false;" ondrop="return false;">
    <main className="w-full mx-auto">
        ...
        <div class="flex pt-8 bg-grey pb-4">
        ...
        <p class=" fontsize-13 regular-color mx-2">請電郵履歷至 swhr@soundwill.com.hk </p>
        <p class=" fontsize-13 regular-color mx-2">(申請人提供之全部資料絕對保密及只作招聘之用) </p>
        ...
        <form class=" w-full mt-12">
            ...
            <div class=" mx-3 px-3 mb-8">
                <div class="flex py-1">
                    ...
                    <button class="w-1/4 fileupload-btn fontsize-11 regular-color rounded">選擇檔案</button>
                </div>
                <div class="flex py-1">
