...
<head>
    ...
    <style>
        ...
        .rentwarehouse-price-select-result-card {
    ...
    <div>
        <main className="flex-1 w-full mx-auto">
            <div>
                ...
                <p class="text1-m pb-2 pl-4">
                    詳細資料
                </p>
                <p class="text0-m py-4 px-4">
                ...
                <div>
                    ...
                    <div class="w-max-content mx-auto">
                        <p class="w-max-content text0-m px-4">
                            可放換季衣服, 兒童物件及玩具,書本
                        </p>
                    ...
                    <img class="mx-auto mb-4" src="{{asset('images/img_webbox.jpg')}}" />
            ...
            {{-- <div class="grid grid-cols-12 px-56">
                <div class="col-start-1 col-span-8 py-8 rentwarehouse-left">
                    <p class="heading2 px-4">黃竹坑(瑞琪分店)</p>
                ...
                <div class="col-start-9 col-span-4 py-8 rentwarehouse-right">
                    ...
                    <div class="rounded-md border border-gray-600 rentwarehouse-price-select-result-card mt-4">
                        <p class="rentwarehouse-price-select-result-card-title py-2 text-center">月費</p>
                        <p class="rentwarehouse-price-select-result-card-content py-5 text-center">$385</p>
                        <div class="w-max-content mx-auto">
                    ...
                    <p class="rentwarehouse-price-select-news-title color-primary">最新資訊</p>
