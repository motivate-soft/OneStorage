    ...
    OneStorage.Calculator = (function () {
        ...
        if(locale == "en")
        {
            categories = [{
                name: 'Commonly used',
                items: [{
                    name: 'Red white blue<br/>5 nylon bags',
                    size: 4
                },
                    {
                        name: 'Ten cardboard boxes',
                        size: 6
                    },
                    {
                        name: 'Ten plastic boxes',
                        size: 8
                    },
                ]
            },
                ...
                },
                {
                    ...
                    items: [{
                        ...
                        {
                            name: 'Small chest of drawers',
                            size: 4
                        },
                        {
                            name: 'Large chest of drawers',
                            size: 8
                        },
                        {
                            name: 'Double bed',
                        ...
                        {
                            name: 'Child-mother bed (detachable)',
                            size: 6
                        },
                        {
                            name: "Folding bed",
                ...
                },
                {
                    ...
                    items: [{
                        ...
                        {
                            name: 'Sitting on the floor photocopier',
                            size: 4
                        },
                        {
                            name: 'Fax machine',
                ...
                },
                {
                    ...
                    items: [{
                        ...
                        {
                            name: 'Computer<br/>(Host and display)',
                            size: 3
                        },
                        {
                            name: 'Computer chair',
